    ...
    <Space>
      <div className={"embed-dashboard-main"}>
        <SpaceVertical>
          ...
          <DevMessage>View JavaScript events <em>from</em> the iframe logged in the <Link href='https://en.wikipedia.org/wiki/Web_development_tools'>developer console.</Link>
          </DevMessage>
          <Space>
            {/* 
